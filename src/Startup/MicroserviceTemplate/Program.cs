...
using MicroserviceTemplate.Application.Settings;
using MicroserviceTemplate.Configuration.Auth;
using MicroserviceTemplate.Configuration.Database;
using MicroserviceTemplate.Configuration.Dependencies;
using MicroserviceTemplate.Configuration.Swagger;
using MicroserviceTemplate.Extensions;
...
// TODO: If you are using .NET Aspire, you can remove the following line
// to configure Serilog as it's moved into ServiceDefaults project. Remove the Serilog
// PackageReferences in MicroserviceTemplate.csproj
